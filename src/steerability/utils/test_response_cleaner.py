...
if __name__ == '__main__':
    ...
    psr.add_argument("--instruction-generator", default="direct")
    psr.add_argument("--llm-name", default="deepseek-ai/DeepSeek-R1-Distill-Llama-8B") # defaults to removing think tags. No-op for non think models.
    args = psr.parse_args()
